...
python tools/run_simulation_sandbox.py --scenario construction_basic --ticks 500 --seed 123 --snapshot out/sim_reports/construction_basic.png --overlay claims,paths,buildings,npcs,blueprints,chunks
```
