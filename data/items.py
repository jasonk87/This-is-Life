...
ITEM_DEFINITIONS = {
    ...
    "bandage": {
        "name": "Linen Bandage",
        "description": "Dresses one bleeding wound. Reduces blood loss; does not erase tissue damage.",
        "char": ITEM_SPRITES["healing_salve"], "color": (218, 210, 182),
        "value": 5, "weight": 0.1, "stackable": True,
        "item_type_tags": ["consumable", "healing"],
        "crafting_recipe": {"cloth": 1},
    },
    "splint": {
        "name": "Wooden Splint",
        "description": "Stabilizes a fractured body part. Bone recovery still takes days of rest.",
        "char": ITEM_SPRITES["healing_salve"], "color": (158, 120, 75),
        "value": 8, "weight": 0.4, "stackable": True,
        "item_type_tags": ["consumable", "healing"],
        "crafting_recipe": {"wooden_plank": 1, "cloth": 1},
    },
    "healing_salve": {
        "name": "Healing Salve",
    ...
    "wool_shirt": {
        "name": "Wool Shirt",
        "description": "A warm, moss-green wool shirt with a belted waist.",
        "char": ord("t"),
        "color": (180, 157, 111),
        "value": 65,
        "weight": 3,
        "stackable": False,
        "item_type_tags": ["armor", "clothing", "body"],
        "equip_slot": "body",
        "properties": {"defense_bonus": 0, "insulation": 7.0, "max_durability": 50},
        "crafting_recipe": {"cloth":5},
        "required_workstation": "loom",
    },
    "linen_trousers": {
        "name": "Linen Trousers",
        "description": "Undyed woven trousers, light enough for everyday work.",
        "char": ord("p"),
        "color": (180, 157, 111),
        "value": 35,
        "weight": 1,
        "stackable": False,
        "item_type_tags": ["armor", "clothing", "legs"],
        "equip_slot": "legs",
        "properties": {"defense_bonus": 0, "insulation": 2.0, "max_durability": 35},
        "crafting_recipe": {"cloth":2},
        "required_workstation": "loom",
    },
    "wool_trousers": {
        "name": "Wool Trousers",
        "description": "Heavy dark wool trousers for cold days.",
        "char": ord("p"),
        "color": (180, 157, 111),
        "value": 55,
        "weight": 2,
        ...
        "item_type_tags": ["armor", "clothing", "legs"],
        "equip_slot": "legs",
        "properties": {"defense_bonus": 0, "insulation": 5.0, "max_durability": 50},
        "crafting_recipe": {"cloth":3},
        "required_workstation": "loom",
    },
    "leather_boots": {
        "name": "Leather Boots",
        "description": "Sturdy calf-high boots with buckled cuffs.",
        "char": ord("b"),
        "color": (180, 157, 111),
        "value": 45,
        "weight": 2,
        "stackable": False,
        "item_type_tags": ["armor", "clothing", "feet"],
        "equip_slot": "feet",
        "properties": {"defense_bonus": 0, "insulation": 3.0, "max_durability": 60},
        "crafting_recipe": {"tanned_leather":3},
    },
    "leather_shoes": {
        "name": "Leather Shoes",
        "description": "Low leather shoes with a laced front.",
        "char": ord("b"),
        "color": (180, 157, 111),
        "value": 25,
        "weight": 1,
        ...
        "item_type_tags": ["armor", "clothing", "feet"],
        "equip_slot": "feet",
        "properties": {"defense_bonus": 0, "insulation": 1.0, "max_durability": 40},
        "crafting_recipe": {"tanned_leather":2},
    },
    "wool_cap": {
        "name": "Wool Cap",
        "description": "A soft, deep-blue wool cap with a turned brim.",
        "char": ord("^"),
        "color": (180, 157, 111),
        "value": 25,
        "weight": 0.5,
        "stackable": False,
        "item_type_tags": ["armor", "clothing", "head"],
        "equip_slot": "head",
        "properties": {"defense_bonus": 0, "insulation": 2.0, "max_durability": 30},
        "crafting_recipe": {"cloth":1},
        "required_workstation": "loom",
    },
    "fishing_rod": {
