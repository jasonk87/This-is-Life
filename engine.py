...
class World:
    ...
    def _start_npc_socialization(self, npc: NPC):
        ...
        for partner in potential_partners:
            assessment = self.evaluate_social_reaction_stance(npc, partner)
            weight = 3 if assessment.stance == "respectful" else 1
        ...
        if self.evaluate_social_reaction_stance(npc, partner).stance == "respectful" and self._can_player_overhear(npc):
            self.add_message_to_chat_log(
