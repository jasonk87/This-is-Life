...
def share_known_fact(speaker, listener, fact, source_type: str = "told") -> bool:
    ...
    listener_knowledge.known_history_facts[fact_id] = KnownHistoryFact(
        ...
        known_at_tick=int(getattr(fact, "known_at_tick", 0) or 0),
