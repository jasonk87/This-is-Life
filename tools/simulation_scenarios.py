...
def run_routing_recovery_and_source_fallback_runtime_soak(seed: int, ticks: int, snapshot_config: SnapshotConfig | None = None) -> ScenarioResult:
    ...
    trace.assert_check(ticks, "fallback_selected", ("produce_logs_building_inventory_selected" in traces) or ("produce_logs_source_fallback_selected" in traces), "compatible fallback source should be selected")
